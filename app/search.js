function searchPage() {
    ...
    getSearchData.open('GET', APIbaseURL + 'api/v1/search?q=' + searchValueNotDecoded + `&page=1`, true);
...
function searchPageContin(continuation, contItemParent) {
    ...
    getSearchData1.open('GET', APIbaseURL + 'api/v1/search?q=' + searchValueNotDecoded + `&page=${continuation}`, true);
